...
describe('Teste unitário do Custo do Sorvete', () => {
    ...
    test('Teste calcular custo com preços personalizados', () => {
        ...
        // Cálculos esperados com preços personalizados:
        // leite: (1000/1000) * 8.0 = 8.00
        // creme: (1000/1000) * 25.0 = 25.00
        // acucar: (1000/1000) * 7.0 = 7.00
        // condensado: (790/395) * 8.0 = 16.00
        // granulado: (500/1000) * 15.0 = 7.50
        // Total: 63.50
